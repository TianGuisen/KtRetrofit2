 ...
 * 网络请回调处理zip
 */
abstract class ZipObserver<T> : DisposableObserver<MutableList<T>>, IObserver<T> {
...
//    }
    ...
    final override fun onNext(t: MutableList<T>) {
        onSuccess(t)
    }

    abstract fun onSuccess(data: MutableList<T>)
